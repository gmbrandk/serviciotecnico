...
const generarDescripcion = require('@utils/movimientos/generarDescripcionMovimiento'); // Ruta a la función de descripción
...
const desactivarUsuario = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ success: false, mensaje: 'Error al desactivar usuario' });
  }
};
