...
import clsx from 'clsx'; // si no lo tienes: npm i clsx
...
const Toast = ({ t, type = 'info', title, message, onClose }) => {
  ...
  return (
    <div
      className={clsx(
        styles.toast,
        styles[type],
        t.visible ? styles['toast-enter'] : styles['toast-exit']
      )}
      data-toast-id={t.id}
    >
      <div className={styles['toast-status-icon']}>{Icon}</div>
